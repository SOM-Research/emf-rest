...
public final class EStructuralFeatureSerializer { 
 public static String serializeEStructuralFeatureList(java.util.List<org.eclipse.emf.ecore.EStructuralFeature> obj, int depth, OutputStream out) throws RuntimeException {
        ByteArrayOutputStream bStream = new ByteArrayOutputStream();
        PrintWriter pw = new PrintWriter(out == null ? new ByteArrayOutputStream() : out);
        JSONWriter jw = new JSONWriter(pw);
        jw.array();
        for (org.eclipse.emf.ecore.EStructuralFeature oi : obj) {
            generateJSONObject(jw, (org.eclipse.emf.ecore.EStructuralFeature)oi, new HashMap<String, String>(), new StringBuffer(), depth);
        }
        jw.endArray();
        if (out == null) {
            try {
	...
	public final static String serialize(org.eclipse.emf.ecore.EStructuralFeature obj, OutputStream out) throws RuntimeException {
		return serialize(obj, 0, out);
	}

	public final static String serialize(org.eclipse.emf.ecore.EStructuralFeature obj, int depth, OutputStream out) {
		ByteArrayOutputStream bStream = new ByteArrayOutputStream();
