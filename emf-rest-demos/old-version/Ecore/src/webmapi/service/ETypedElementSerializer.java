...
public final class ETypedElementSerializer { 
 public static String serializeETypedElementList(java.util.List<org.eclipse.emf.ecore.ETypedElement> obj, int depth, OutputStream out) throws RuntimeException {
        ByteArrayOutputStream bStream = new ByteArrayOutputStream();
        PrintWriter pw = new PrintWriter(out == null ? new ByteArrayOutputStream() : out);
        JSONWriter jw = new JSONWriter(pw);
        jw.array();
        for (org.eclipse.emf.ecore.ETypedElement oi : obj) {
            generateJSONObject(jw, (org.eclipse.emf.ecore.ETypedElement)oi, new HashMap<String, String>(), new StringBuffer(), depth);
        }
        jw.endArray();
        if (out == null) {
            try {
	...
	public final static String serialize(org.eclipse.emf.ecore.ETypedElement obj, OutputStream out) throws RuntimeException {
		return serialize(obj, 0, out);
	}

	public final static String serialize(org.eclipse.emf.ecore.ETypedElement obj, int depth, OutputStream out) {
		ByteArrayOutputStream bStream = new ByteArrayOutputStream();
