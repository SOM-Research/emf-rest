...
public class CompoundENamedElementResource{

    private java.util.List<ENamedElement> listInstance;
	...
	private webmapi.service.container.ENamedElementContainer instance;
    
    public CompoundENamedElementResource(ENamedElement instance){
        ArrayList list = new ArrayList();
        list.add(instance);
        initialize(list);
    }
    
    public CompoundENamedElementResource(java.util.List<ENamedElement> listInstance){
         initialize(listInstance);
    }
    
    private void initialize(java.util.List<ENamedElement> listInstance){
    	this.listInstance = listInstance;
		for(ENamedElement element: listInstance){
     	...
     	instance = new webmapi.service.container.ENamedElementContainer(
eAttributeList  
 ...
 , eTypeParameterList  
	...
	@GET
	public webmapi.service.container.ENamedElementContainer getENamedElementContainer(){
		return instance; 
	}
	
		
	@PUT
	public void updateENamedElement(ENamedElement eNamedElement){
