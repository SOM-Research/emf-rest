...
public class DaughterAdapter extends XmlAdapter<DaughterProxy, Daughter> {
	...
	@Override
	public DaughterProxy marshal(Daughter arg0) throws Exception {

		DaughterProxy d = ProxyFactory.createDaughterProxy(arg0.eClass().getName());
	...
	@Override
	public Daughter unmarshal(DaughterProxy arg0) throws Exception {
		ExampleFactory factory = ExampleFactory.eINSTANCE;
		return ProxyFactory.createDaughter(arg0);
	}

	public String getURL(Daughter obj) {
		Map<EObject, EReference> map = new HashMap<EObject, EReference>();
		String id = IdentificationResolver.getDaughterId(obj);
		EObject temp = obj;
