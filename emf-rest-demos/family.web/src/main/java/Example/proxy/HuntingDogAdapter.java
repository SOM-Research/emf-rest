...
public class HuntingDogAdapter extends XmlAdapter<HuntingDogProxy, HuntingDog> {
	...
	@Override
	public HuntingDogProxy marshal(HuntingDog arg0) throws Exception {

		HuntingDogProxy d = ProxyFactory.createHuntingDogProxy(arg0.eClass().getName());
	...
	@Override
	public HuntingDog unmarshal(HuntingDogProxy arg0) throws Exception {
		ExampleFactory factory = ExampleFactory.eINSTANCE;
		return ProxyFactory.createHuntingDog(arg0);
	}

	public String getURL(HuntingDog obj) {
