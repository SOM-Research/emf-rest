...
import Example.proxy.DaughterProxy;
...
@XmlSeeAlso({ DaughterProxy.class, Wrapper.class, FamilyImpl.class })
public class DaughterImpl extends MemberImpl implements Daughter {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public Family getFamily() {
		if (eContainerFeatureID() != ExamplePackage.DAUGHTER__FAMILY)
			return null;
	...
	public void setFamily(Family newFamily) {
		if (newFamily != eInternalContainer()
				|| (eContainerFeatureID() != ExamplePackage.DAUGHTER__FAMILY && newFamily != null)) {
			...
			if (newFamily != null)
				msgs = ((InternalEObject) newFamily).eInverseAdd(this, ExamplePackage.FAMILY__DAUGHTERS, Family.class,
						msgs);
			msgs = basicSetFamily(newFamily, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExamplePackage.DAUGHTER__FAMILY, newFamily,
					newFamily));
	}
